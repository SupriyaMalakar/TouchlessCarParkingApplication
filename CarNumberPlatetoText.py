# -*- coding: utf-8 -*-
"""
Created on Tue Jun  2 13:49:39 2020
...
def main():
    ...
    img = cv2.imread("C:\Training Materials\Python\Practise\TouchLess Parking\Image\Test3.jpg")
...
`
    ...
    df.to_csv('Dataset_VehicleNo.csv',mode='a')
